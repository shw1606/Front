...
// 서버에 이름순 태그 데이터 LOAD
export const ALPHABET_TAGS_LOAD_REQUEST = "ALPHABET_TAGS_LOAD_REQUEST";
export const ALPHABET_TAGS_LOAD_SUCCESS = "ALPHABET_TAGS_LOAD_SUCCESS";
export const ALPHABET_TAGS_LOAD_FAILURE = "ALPHABET_TAGS_LOAD_REQUEST";

// 서버에 게시글 데이터 LOAD
export const TRENDING_POSTS_LOAD_REQUEST = "TRENDING_POSTS_LOAD_REQUEST";
export const TRENDING_POSTS_LOAD_SUCCESS = "TRENDING_POSTS_LOAD_SUCCESS";
export const TRENDING_POSTS_LOAD_FAILURE = "TRENDING_POSTS_LOAD_REQUEST";

// 서버에 최신 게시글 데이터 LOAD
export const RECENT_POSTS_LOAD_REQUEST = "RECENT_POSTS_LOAD_REQUEST";
export const RECENT_POSTS_LOAD_SUCCESS = "RECENT_POSTS_LOAD_SUCCESS";
export const RECENT_POSTS_LOAD_FAILURE = "RECENT_POSTS_LOAD_REQUEST";
